...
function topFunction() {
  ...
  document.documentElement.scrollTop = 0;
	...
	<section class="container">
		...
		<div class="second">
			<?php
					$have_friend=mysql_query("select * from friends where user_id='$profile_id' and friend=1");
					if (!$have_friend) die ("Select * error: " . mysql_error());
					$rs=mysql_num_rows($have_friend);
					echo "<div class='padding'> <div class='title'>All friends <font>$rs</font></div><hr>";
