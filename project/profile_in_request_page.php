...
function topFunction() {
  ...
  document.documentElement.scrollTop = 0;
	...
	<section class="container">
		...
		<div class="second">
			<?php
					$have_friend=mysql_query("select * from friends where follows_id='$profile_id' and friend=0");
					if (!$have_friend) die ("Select * error: " . mysql_error());
					$rs=mysql_num_rows($have_friend);
					echo "<div class='padding'> <div class='title'>All subscribers <font>$rs</font></div><hr>";
					...
					for ($j =0; $j <$rs ; ++$j){	
						...
						echo "<div class='friend'>
								...
								<?php }
									...
									echo "<font>$name_user $surname_user</font><br></a>
		...
		<div class="third">
			<div class="links">
				<div>
					<div class="friend">
						<div class="friend-image">
							<a href='http://socnet/profile_page.php?id=<?=$profile_id?>&login=<?=$profile_login?>'>
								<?php
									if(!empty($profile_img)){?>
										<img src='data:image/jpeg;base64, <?=$profile_img ?>' class='round-image' width='80px' height='80px' style='object-fit: cover;'>
									<?php }
									else{
										?>	<img src='account_1.png' class='round-image' width='80px'>
										<?php
						...
						<div class='friend-info'>
							<a href='http://socnet/profile_page.php?id=<?=$profile_id?>&login=<?=$profile_login?>'>
							<font><?php echo $profile_name; echo " "; echo $profile_surname; ?></font><br></a>
							<font id='city'><?php echo $profile_city; ?></font>
						</div>
					</div>
				</div>
				<div class="row">
					<a href="profile_friends_page.php?id=<?=$profile_id?>">Friends</a>
				</div>
				<div class="row" style="background-color: rgba(70,62,122,0.1);">
					<a href="profile_in_request_page.php?id=<?=$profile_id?>">Subscribers</a>
				</div>
			</div>
		</div>
</section>
